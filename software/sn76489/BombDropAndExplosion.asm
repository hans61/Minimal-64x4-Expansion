; Dauer des Sounds ca. 4 Sekunden
...
loop1:
	...
	LDI 144 JAS wrSN76489	; 0x90
	MIZ 5,varJ				; FOR J=5 TO 17
loopJ:
	MIZ 128,varI			; FOR I=128 TO 143
loopI:
	LDZ varI JAS wrSN76489
	LDZ varJ JAS wrSN76489
	MIZ 10,regB JPS w250ms	; ca. 10ms
	INZ varI
	CPI 144
	BNE loopI				; NEXT I
	INZ varJ
	CPI 18
	BNE loopJ				; NEXT J
	LDI 159 JAS wrSN76489
	LDI 228 JAS wrSN76489
	MIZ 240,varI
loopI2:
	LDZ varI JAS wrSN76489
	MIZ 114,regB JPS w250ms	; ca. 114ms
	INZ varI
	CPI 0
	BNE loopI2				; NEXT I
